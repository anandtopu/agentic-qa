...
resource "aws_security_group" "cluster" {
  ...
  vpc_id      = var.vpc_id
  description = "EKS control-plane SG (managed; in/out rules added by EKS)."
...
# OIDC provider for IRSA. The IAM module attaches roles by referencing
# the URL + ARN exposed in outputs.tf.
