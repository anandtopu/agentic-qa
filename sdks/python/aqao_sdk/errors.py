...
_STATUS_TO_ERROR: dict[int, type[AQAOError]] = {
    401: AuthError,
...
def error_for_status(
    *,
    ...
    cls = _STATUS_TO_ERROR.get(status_code, AQAOError)
