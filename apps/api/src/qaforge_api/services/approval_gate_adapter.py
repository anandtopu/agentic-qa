...
:class:`qaforge_agents.runtime.ApprovalGate` Protocol.

Story 2.1.2 — the workflow runtime lives in ``qaforge_agents`` and
must not import from ``qaforge_api``. This adapter sits in the API
