...
from qaforge_agents.llm.types import UsageRecord
from qaforge_api.db.models import UsageRecordRow


@dataclass(slots=True)
class DbUsageRecorder:
    """Implements :class:`qaforge_agents.llm.recorder.UsageRecorder`.
