...
from aqao_api.flags.types import FlagStore

_FLAGS_ENV_VAR = "AQAO_FEATURE_FLAGS"
...
class FeatureFlagClient:
    ...
    def __init__(self, store: FlagStore) -> None:
        self._store = store
        self._log = structlog.get_logger("aqao_api.flags")
...
def get_feature_flag_client() -> FeatureFlagClient:
    """Process-wide singleton built from the ``AQAO_FEATURE_FLAGS`` env var."""
