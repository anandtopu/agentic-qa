...
class Settings(BaseSettings):
    ...
    All variables are prefixed `AQAO_` except provider keys, which use
    ...
    database_url: str = "postgresql+psycopg://aqao:aqao@localhost:5432/aqao"
    redis_url: str = "redis://localhost:6379/0"

    s3_endpoint_url: str | None = None
    s3_bucket: str = "aqao-evidence"
    ...
    otel_service_name: str = "aqao-api"
