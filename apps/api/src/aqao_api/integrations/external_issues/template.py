...
*Agentic QA Orchestrator defect report*
...
{% endif %}_Agentic QA Orchestrator correlation: {{ signal_id }}_
"""
...
{% endif %}{% if labels %}*Labels:* {{ labels | join(", ") }}
{% endif %}<sub>Agentic QA Orchestrator correlation: `{{ signal_id }}`</sub>
"""
