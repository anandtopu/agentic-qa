...
from aqao_api.audit.signing import canonical_payload, compute_signature
...
class AuditService:
    ...
    def __init__(self, session: Session, *, hmac_key: str | None = None) -> None:
        ...
        self._log = structlog.get_logger("aqao_api.services.audit")
    ...
    def _sign(self, event: AuditEvent) -> str | None:
        ...
        if not secret:
            self._log.warning(
                ...
                reason="AQAO_AUDIT_HMAC_KEY missing or empty",
