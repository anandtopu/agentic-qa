...
from aqao_agents.api_tester.schema import GeneratedTestSuite

PROMPT_VERSION = "1.0.0"

SYSTEM = """\
You are Agentic QA Orchestrator's API Testing Agent. You convert an OpenAPI requirement
...
2. ``source_code`` must be valid Python 3.12. It must:
   ...
   - read the base URL from `os.environ["AQAO_API_BASE_URL"]`;
   - read auth from `os.environ.get("AQAO_API_TOKEN")` and pass as
