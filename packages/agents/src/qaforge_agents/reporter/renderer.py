...
from qaforge_agents.reporter.types import RunReportContext
...
class MarkdownReportRenderer:
    ...
    The template lives at ``qaforge_agents/reporter/templates/run_report.md.j2``
    ...
    def render(self, context: RunReportContext) -> str:
        env = Environment(
            loader=PackageLoader("qaforge_agents.reporter", "templates"),
